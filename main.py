...
if __name__ == '__main__':
    ...
    for stock_code in args.stock_code:
        ...
        # 최소/최대 투자 단위 설정
        min_trading_unit = max(int(100000 / chart_data.iloc[-1,:]['close']), 1) #여기 숫자 100000는 변수로 바꿔줘라 
        max_trading_unit = max(int(1000000 / chart_data.iloc[-1,:]['close']), 1)#여기 숫자 1000000는 변수로 바꿔줘라 
        ...
        if args.rl_method != 'a3c':
            ...
            list_training_data.append(training_data) # 특정stock_code의 기간날짜안의 training_data(여러피쳐, 2차원)을 append시킴.
